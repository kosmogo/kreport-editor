  ...
  _CAFEINE_ROOT.Cafeine.Editable = (function(_super) {
    ...
    Editable.editable = function(field_list) {
      ...
      return (_ref8 = (_base7 = this.prototype).create_edit_form) != null ? _ref8 : _base7.create_edit_form = function(opts) {
        var content, field, field_id, fields, k, label, m, markups, opt, option, self, v, _i, _j, _len, _len1, _ref10, _ref11, _ref12, _ref13, _ref9,
          _this = this;
        opts = Cafeine.merge({
          buttons: {
        ...
        for (k in _ref9) {
          ...
          label.innerHTML = (_ref11 = v.label) != null ? _ref11 : k.underscorize();
          label.setAttribute("for", field.id);
          label.setAttribute("title", (_ref12 = (_ref13 = v.description) != null ? _ref13 : v.label) != null ? _ref12 : k.underscorize());
        ...
        content.apply_to_object = function() {
          var _ref14;
          _ref14 = _this.constructor["_editable_fields"];
          for (k in _ref14) {
            v = _ref14[k];
  ...
  _CAFEINE_ROOT.Cafeine.Plugin = (function(_super) {
    ...
    Plugin.jquery_plugin = function(name, todo) {
      ...
      return jQuery.fn[name] = function() {
        ...
        $this.each(function() {
          if (this["_module_" + name] == null) {
            this["_module_" + name] = Cafeine.invoke(clazz, [this].concat(args));
          }
          return block != null ? block.apply(this["_module_" + name], args) : void 0;
        });
        if (todo != null) {
          todo.call(this);
        }
